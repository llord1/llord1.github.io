...
Notably, Maslow's hierarchy of needs is often employed to illustrate why projects have failed (particularly the five-tiered version). Due to being sought as issues arise, this theory begets a negative connotation. A lesser-known, more introspective, and positive eight-tiered version, does exist.
...
Data Science is still an actively developing field; due to program lengths for P.h.D programs, it may be very difficult to create a timely yet comprehensive compilation on all available topics, techniques, and technologies. The intention is not to compile a comprehensive list of all possible avenues of data science. It aimed to spur interest in the field, and provide starting points for personal exploration. 

This endeavor is quite a complicated undertaking to publish as a single contributor. Co-authorship on works may need to be sought to better handle the workload of research and coding these tools. Framework users will require less preparation as introductory research on these tools would already have been completed.
