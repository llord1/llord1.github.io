...
With this proposed framework, the order in which one can pursue the topics is not as significant as increased satisfaction the user will receive with each completed area of knowledge. However, users that do complete tasks at all levels of the structure can provide meaningful data science contributions to the field and society at large; ultimately, it is hoped to facilitate the user with achieving an authentic sense of self-actualization. 
