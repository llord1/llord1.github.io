...
In terms of creole data, I currently have access to public social media data {% cite kweyol_fb_joseph  kweyol_works_joseph %}, stories {% cite sil_readingbook_1989 %}, traditional folk songs {% cite joseph_songs_2020 SLU_song_yannucci_2020 %}, discourses {% cite weekes2014bodies %}, digital versions of a bible (new testament) {% cite SLUnewtestament_1999 bibleproject_2004 BibleSocieties_2020 %}, and a few documents from the government such as the Saint Lucian national anthem {% cite anthem_2016 %} and creole public service announcements {% cite louisy_govt_2004 %}.There are few books but they are mostly physical documents (I need to finish looking into their digital versions). In 1993 a document entitled "Dances and Songs from a Caribbean Island" was created and in 1996 one named "Select Bibliography of the Literature of the English-speaking West Indies" was also created; if the documents above are insufficient, I will consult these two anthological works for additional data {% cite islandsongs_1993 creolelitlist1996 %}. I also have access to a partially labeled XML dictionary dataset in the target language of Saint Lucian Kwéyòl (but no sentiment data). There are numerical indicators to signify the differences between homonyms, and according to the dictionary's creator
