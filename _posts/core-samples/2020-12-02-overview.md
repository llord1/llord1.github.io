...
Frank's 2008 work on "Sources of St. Lucian Creole Vocabulary" suggested that about 83.8 % -95.0 % words he came across had French origins,  about 2.8 % to 3.2 % were English, .6 % to .7 % were Amerindian-based, and about .5 % to .6 % were African-based; .4 %  were Indian language-based (Tamil or Hindi), and .1 % was Spanish/Portuguese-based. A notable 11.8 % were St. Lucian Creole lexical items for which the etymological source could not be precisely determined {% cite frank2007sources %}.
