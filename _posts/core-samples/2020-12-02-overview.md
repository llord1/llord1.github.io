...
Since I do intend to discuss matters related to computational linguistics, frameworks, and my dissertation's societal value to low-resource languages (biocultural diversity topics), I do believe that this is an appropriate target. However, this does not mean that other publishers will not be considered; I am also open to suggestions and changes concerning this matter. Please see below for details on publications currently being considered.
