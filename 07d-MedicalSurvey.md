...
*10. Please indicate how often you encounter each of the following languages during typical patient interactions. This question requires one response per row.*
...
*(Continued)10. Please indicate how often you encounter each of the following languages during typical patient interactions. This question requires one response per row.*
