...
-Due to increased access to digital resources in an environment that supposedly has a 'widely used' low resource language, can one dependably lean on modern data collection methods (online surveys) to confirm its vitality? 
 
-How can useful vitality statistics be gleaned from professions that inherently bear high levels of critical interactions with the public, and simultaneously bear the greatest likelihood of technology usage? 
 
-What percentage of professionals consider themselves fluent in a low-resource hereditary language, and is it crucial to their professional interactions? 
 
-Can typical outlines of normative data generation be applied to low-resource languages, such as creoles that are typically orally taught, without issue?  
 
Data: 
 
1. Survey of Saint Lucian lawyers (IRB approved and distributed via Saint Lucia Bar Association). 
2. Survey of Saint Lucian teachers (drafted and in discussions with Ministry of Education; will be attending the August 31st  Saint Lucia National Language Policy Implementation Conference). 
3. Survey of Saint Lucian law enforcement (drafted and in discussions with the Royal Saint Lucia Police Force). 
