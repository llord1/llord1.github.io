...
#### The Role of Data Science, Digital Humanities, and Biocultural Diversity
...
During the 2020 SARS-CoV-2 pandemic, global citizens began critically assessing existing problematic policies and strove to create and cement beneficial policies for the future. Institutions began revisiting previously overlooked policy proposals in concerted efforts to provide valuable projects to the public. Notably, academics renewed efforts to investigate biodiversity conservation {% cite bates_2020 %}. On a small-scale, some institutions sought and secured approvals for extending nature reserves {% cite neill_reserve_2020 %}. On a larger-scale, despite some regulatory rollbacks, as of July 7th, climate activists saw celebrated the abandonment of the Atlantic Coast Pipeline, and the shut-down and emptying of the Dakota Access Pipeline, pending a long-awaited thorough environmental review {% cite simroth_2020 cowan_2020 tamborrino_2020
...
Notably, Maslow's hierarchy of needs is often employed to illustrate why projects have failed (particularly the five-tiered version). Due to being sought as issues arise, this theory begets a negative connotation. However, a lesser-known, more introspective eight-tiered version does exist.

## The Proposed Framework:

With the reenvisioning of Maslow's hierarchy of needs, the public might have a more positive perspective of this pyramid. Those wishing to enact change in their spaces can be reassured that each completed project is a step closer to a better understanding of what is happening and what can then be done. 

Moreover, this novel structure can serve as a self-assessment tool. One may use it when reviewing past tasks and or when revaluating career choices. It can serve as a means of ascertaining if one's choices have effectively contributed to any of their needs and if it promoted personal progress. It may also offer direction to those considering a career in data science yet lack sufficient exposure to practical applications of concepts. 
...
Communication barriers can present issues with affiliation goals; therefore it may be useful to study how physical and mental limitations can impact affiliation. For example, even neurolinguistics topics related to traumatic brain injury and aphasia can be sorted into this level; this is because it can be useful to investigate topics that hamper effective communication and create tools to address these issues. 

In terms of technology, the same base of Python and R can be utilized; however, one can also attempt more intensive data linguistic tools and techniques. Tensorflow with the implementation of neural machine translation (with Attention mechanisms) along with co-occurrence graphs different subject matters.
